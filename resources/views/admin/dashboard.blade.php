                ...
                <div class="col-12 grid-margin d-flex align-items-stretch">
                  <div class="row">
                    <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-facebook"><p class="mb-0">CSE</p><P style="font-family:cursive; font-size:30px; font-weight:bold; text-align:center">{{ $student}}</P> </div>
                      @php
                      $student=DB::table('student')
                          ->select(DB::raw('count(*) as Student_department'))
                          ->where('Student_department','$Student_department==1')
                          ->first('Student_department');
                      @endphp
                  
                    </div>
                    <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-twitter"><p class="mb-0">EEE</p></div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-google"><p class="mb-0">BBA</p></div>
                    </div>
