            ...
            <div class="col-lg-12 side-left">
              <div class="card mb-12">
                <div class="card-body avatar">
                  ...
                  <p class="designation">{{covert_department($student_description_profile->Student_department)}}</p>
                  <a class="email" href="#">{{$student_description_profile->Student_email}}</a>
                  <a class="number" href="#">{{$student_description_profile->Student_roll}}</a>
                </div>
              </div>
              <div class="card mb-12">
                <div class="card-body overview">
                  ...
                  <div class="info-links">
                    ...
                    <a class="website" >
                      ...
                      <span style="font-family:vernada; font-size:15px;">{{$student_description_profile->Student_phone}}</span>
                    </a>
