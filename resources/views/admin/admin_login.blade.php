            ...
            <div class="card-body px-5 py-5">
              ...
              <form method="post" action="{{ url('/adminlogin') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control p_input" name="admin_email" placeholder="Admin Email">
                </div>
                <div class="form-group">
                  <label>Password *</label>
                  <input type="text" class="form-control p_input" name="admin_password" placeholder="Admin Password">
                </div>
